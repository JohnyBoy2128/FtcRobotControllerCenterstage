...
@Autonomous(name = "CS: RedLeftAuto", group = "Autos")
public class RedLeftAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d startPose = new Pose2d(-36, -62.75, Math.toRadians(90));
        ...
        TrajectorySequence testTrack = drive.trajectorySequenceBuilder(startPose)
                ...
                // move to spike strip tile
                .splineTo(new Vector2d(-36.04, -36.00), Math.toRadians(90.00))
                .waitSeconds(0.5)
                ...
                .lineToLinearHeading(new Pose2d(50.00, -36.00, Math.toRadians(360.00)))
                .build();
