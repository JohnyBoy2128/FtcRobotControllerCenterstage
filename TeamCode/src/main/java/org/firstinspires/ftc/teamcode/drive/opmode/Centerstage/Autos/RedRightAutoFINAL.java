...
public class RedRightAutoFINAL extends BaseAuto {

    // POSITIONS GOOD
    public static customPose2D boardRight = new customPose2D(50, -42.5, 0);
    public static customPose2D boardCenter = new customPose2D(50, -35, 0);
    ...
    public static customPose2D lineCenter = new customPose2D(17, -39, 90);
    public static customPose2D lineLeft = new customPose2D(14.375, -31, 180);
